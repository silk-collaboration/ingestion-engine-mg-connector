...
//        echo $this->getCode();
//        echo "import job 3  ---  \n";
//        echo 'ingestionengine_connector_import_step_start_'.strtolower($this->getCode());
...
//        }
        ...
        $this->eventManager->dispatch('ingestionengine_connector_import_step_start', ['import' => $this]);

        $this->eventManager->dispatch(
            'ingestionengine_connector_import_step_start_'.strtolower($this->getCode()),
            ['import' => $this]
        );
        $this->initStatus();
        ...
        $this->eventManager->dispatch('ingestionengine_connector_import_step_finish', ['import' => $this]);
        $this->eventManager->dispatch(
            'ingestionengine_connector_import_step_finish_'.strtolower($this->getCode()),
            ['import' => $this]
        );
    ...
    {
        if ($this->ingestionengineClient === false) {
    ...
    /**
     * Get IngestionEngine Client instance
     *
     * @return IngestionEnginePimEnterpriseClientInterface|false
     */
    public function getIngestionEngineClient()
    {
        try {
            /** @var IngestionEnginePimEnterpriseClientInterface|false $ingestionengineClient */
            $ingestionengineClient = $this->authenticator->getIngestionEngineApiClient();
        } catch (\Exception $e) {
            $ingestionengineClient = false;
        }

        return $ingestionengineClient;
    }
}
