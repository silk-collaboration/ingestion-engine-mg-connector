...
class Family extends Import
{
    ...
    public function createTable()
    {
        ...
        $families = $this->ingestionengineClient->getFamilyApi()->listPerPage(1);
        /** @var array $family */
        ...
        while (($row = $query->fetch())) {
            ...
            if (in_array($familyName, $familyNames)) {
                ...
                $this->setAdditionalMessage(
                    __('Family with code "%1" has the same label than another family in IngestionEngine and has been skipped from import', $familyCode)
                );
