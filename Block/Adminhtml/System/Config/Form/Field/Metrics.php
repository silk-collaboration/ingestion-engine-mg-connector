...
use IngestionEngine\Connector\Model\Source\Attribute\Metrics as MetricsSource;
...
class Metrics extends AbstractFieldArray
{
    ...
    {
        $this->addColumn('ingestionengine_metrics', ['label' => __('IngestionEngine Metric Attribute')]);
    ...
    public function renderCellTemplate($columnName)
    {
        ...
        if ($columnName == 'ingestionengine_metrics') {
