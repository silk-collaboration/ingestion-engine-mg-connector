...
class Log extends AbstractModel implements LogInterface, IdentityInterface
{
     ...
     */
    const CACHE_TAG = 'ingestionengine_connector_import_log';
     ...
     * @var string
     */
    protected $_eventPrefix = 'ingestionengine_connector_import_log';
    ...
    {
        $this->_init('IngestionEngine\Connector\Model\ResourceModel\Log');
    }
