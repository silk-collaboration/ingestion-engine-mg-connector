...
use IngestionEngine\Connector\Helper\Config;
use IngestionEngine\Connector\Helper\Serializer;
...
class Attribute
{
    ...
    protected function getConfiguration($inputType = 'default')
    {
        ...
        $this->eventManager->dispatch(
            'ingestionengine_connector_attribute_get_configuration_add_before',
            ['response' => $response]
        );
    ...
    public function getAvailableTypes()
    {
        ...
        $this->eventManager->dispatch(
            'ingestionengine_connector_attribute_get_available_types_add_after',
            ['response' => $response]
        );
    ...
    public function getSpecificColumns()
    {
        ...
        $this->eventManager->dispatch(
            'ingestionengine_connector_attribute_get_specific_columns_add_after',
            ['response' => $response]
        );
