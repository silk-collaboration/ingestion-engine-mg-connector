...
class Product extends Entities
{
     ...
     * @param string $prefix
     *
     * @return \IngestionEngine\Connector\Helper\Import\Product
     */
    public function matchEntity($pimKey, $entityTable, $entityKey, $import, $prefix = null)
    {
        ...
        /* Connect existing Magento products to new IngestionEngine items */
        ...
        while ($row = $query->fetch()) {
            // Create a row in IngestionEngine table for products present in Magento and IngestionEngine that were never imported before
