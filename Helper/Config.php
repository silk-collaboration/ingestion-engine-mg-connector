...
{
    /** Config keys */
    const INGESTIONENGINE_API_BASE_URL = 'ingestionengine_connector/ingestionengine_api/base_url';
    const INGESTIONENGINE_API_USERNAME = 'ingestionengine_connector/ingestionengine_api/username';
    const INGESTIONENGINE_API_PASSWORD = 'ingestionengine_connector/ingestionengine_api/password';
    const INGESTIONENGINE_API_CLIENT_ID = 'ingestionengine_connector/ingestionengine_api/client_id';
    const INGESTIONENGINE_API_CLIENT_SECRET = 'ingestionengine_connector/ingestionengine_api/client_secret';
    const INGESTIONENGINE_API_PAGINATION_SIZE = 'ingestionengine_connector/ingestionengine_api/pagination_size';
    const INGESTIONENGINE_API_ADMIN_CHANNEL = 'ingestionengine_connector/ingestionengine_api/admin_channel';
    const INGESTIONENGINE_API_WEBSITE_MAPPING = 'ingestionengine_connector/ingestionengine_api/website_mapping';
    const PRODUCTS_FILTERS_MODE = 'ingestionengine_connector/products_filters/mode';
    const PRODUCTS_FILTERS_COMPLETENESS_TYPE = 'ingestionengine_connector/products_filters/completeness_type';
    const PRODUCTS_FILTERS_COMPLETENESS_VALUE = 'ingestionengine_connector/products_filters/completeness_value';
    const PRODUCTS_FILTERS_COMPLETENESS_LOCALES = 'ingestionengine_connector/products_filters/completeness_locales';
    const PRODUCTS_FILTERS_STATUS = 'ingestionengine_connector/products_filters/status';
    const PRODUCTS_FILTERS_FAMILIES = 'ingestionengine_connector/products_filters/families';
    const PRODUCTS_FILTERS_UPDATED_MODE = 'ingestionengine_connector/products_filters/updated_mode';
    const PRODUCTS_FILTERS_UPDATED_LOWER = 'ingestionengine_connector/products_filters/updated_lower';
    const PRODUCTS_FILTERS_UPDATED_GREATER = 'ingestionengine_connector/products_filters/updated_greater';
    const PRODUCTS_FILTERS_UPDATED_BETWEEN_AFTER = 'ingestionengine_connector/products_filters/updated_between_after';
    const PRODUCTS_FILTERS_UPDATED_BETWEEN_BEFORE = 'ingestionengine_connector/products_filters/updated_between_before';
    const PRODUCTS_FILTERS_UPDATED_SINCE = 'ingestionengine_connector/products_filters/updated';
    const PRODUCTS_FILTERS_ADVANCED_FILTER = 'ingestionengine_connector/products_filters/advanced_filter';
    const PRODUCTS_CATEGORY_IS_ACTIVE = 'ingestionengine_connector/category/is_active';
    const PRODUCTS_CATEGORY_INCLUDE_IN_MENU = 'ingestionengine_connector/category/include_in_menu';
    const PRODUCTS_CATEGORY_IS_ANCHOR = 'ingestionengine_connector/category/is_anchor';
    const PRODUCTS_CATEGORY_CATEGORIES = 'ingestionengine_connector/category/categories';
    const PRODUCT_ATTRIBUTE_MAPPING = 'ingestionengine_connector/product/attribute_mapping';
    const PRODUCT_WEBSITE_ATTRIBUTE = 'ingestionengine_connector/product/website_attribute';
    const PRODUCT_CONFIGURABLE_ATTRIBUTES = 'ingestionengine_connector/product/configurable_attributes';
    const PRODUCT_PRODUCT_MODEL_BATCH_SIZE = 'ingestionengine_connector/product/product_model_batch_size';
    const PRODUCT_PRODUCT_MODEL_UPDATE_LENGTH = 'ingestionengine_connector/product/product_model_update_length';
    const PRODUCT_TAX_CLASS = 'ingestionengine_connector/product/tax_class';
    const PRODUCT_URL_GENERATION_ENABLED = 'ingestionengine_connector/product/url_generation_enabled';
    const PRODUCT_MEDIA_ENABLED = 'ingestionengine_connector/product/media_enabled';
    const PRODUCT_MEDIA_IMAGES = 'ingestionengine_connector/product/media_images';
    const PRODUCT_MEDIA_GALLERY = 'ingestionengine_connector/product/media_gallery';
    const PRODUCT_FILE_ENABLED = 'ingestionengine_connector/product/file_enabled';
    const PRODUCT_FILE_ATTRIBUTE = 'ingestionengine_connector/product/file_attribute';
    const PRODUCT_METRICS = 'ingestionengine_connector/product/metrics';
    const PRODUCT_INGESTIONENGINE_MASTER = 'ingestionengine_connector/product/ingestionengine_master';
    const ATTRIBUTE_TYPES = 'ingestionengine_connector/attribute/types';
    const PRODUCT_ACTIVATION = 'ingestionengine_connector/product/activation';
    /**
     ...
     */
    protected $filesMediaFile = 'ingestionengine_connector/media_files';
    /**
    ...
    /**
     * Retrieve IngestionEngine base URL
     *
     * @return string
     */
    public function getIngestionEngineApiBaseUrl()
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_BASE_URL);
    }

    /**
     * Retrieve IngestionEngine username
     *
     * @return string
     */
    public function getIngestionEngineApiUsername()
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_USERNAME);
    }

    /**
     * Retrieve IngestionEngine password
     *
     * @return string
     */
    public function getIngestionEngineApiPassword()
    {
        /** @var string $password */
        $password = $this->scopeConfig->getValue(self::INGESTIONENGINE_API_PASSWORD);

        return $this->encryptor->decrypt($password);
    }

    /**
     * Retrieve IngestionEngine client_id
     *
     * @return string
     */
    public function getIngestionEngineApiClientId()
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_CLIENT_ID);
    }

    /**
     * Retrieve IngestionEngine client_secret
     *
     * @return string
     */
    public function getIngestionEngineApiClientSecret()
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_CLIENT_SECRET);
    }

    /**
     * Retrieve IngestionEngine page_size
     *
     * @return string
     */
    public function getIngestionEngineApiPageSize()
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_PAGINATION_SIZE);
    }
     ...
     * @return bool
     */
    public function checkIngestionEngineApiCredentials()
    {
        if (!$this->getIngestionEngineApiBaseUrl() || !$this->getIngestionEngineApiClientId() || !$this->getIngestionEngineApiClientSecret(
            ) || !$this->getIngestionEngineApiPassword() || !$this->getIngestionEngineApiUsername()) {
            return false;
        }
     ...
     *
     * @return string
     * @see \IngestionEngine\Connector\Model\Source\Filters\Mode
     *
     */
     ...
     *
     * @return string
     * @see \IngestionEngine\Connector\Model\Source\Filters\Completeness
     *
     */
     ...
     *
     * @return string
     * @see \IngestionEngine\Connector\Model\Source\Filters\Status
     *
     */
    ...
    {
        return $this->scopeConfig->getValue(self::INGESTIONENGINE_API_ADMIN_CHANNEL);
    }
    ...
    public function getWebsiteMapping($withDefault = true)
    {
        ...
        $websiteMapping = $this->scopeConfig->getValue(self::INGESTIONENGINE_API_WEBSITE_MAPPING);
    ...
    public function getPaginationSize()
    {
        ...
        $paginationSize = (int)$this->scopeConfig->getValue(self::INGESTIONENGINE_API_PAGINATION_SIZE);
        if (!$paginationSize) {
    ...
    /**
     * Description isIngestionEngineMaster function
     *
     * @return bool
     */
    public function isIngestionEngineMaster()
    {
        return $this->scopeConfig->isSetFlag(self::PRODUCT_INGESTIONENGINE_MASTER);
    }
    ...
    public function getMetricsColumns($returnVariant = null, $returnConcat = null)
    {
        ...
        foreach ($unserializeMetrics as $unserializeMetric) {
            ...
            $metricAttributeCode = $unserializeMetric['ingestionengine_metrics'];
    ...
    public function isUrlKeyMapped()
    {
        ...
        foreach ($matches as $match) {
            if (!isset($match['ingestionengine_attribute'], $match['magento_attribute'])) {
                continue;
            }
